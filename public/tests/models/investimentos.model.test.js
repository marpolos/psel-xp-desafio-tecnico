    ...
    describe('Método matchAtivoCliente', function () {
        it('Ao enviar codCliente e codAtivo relacionados retorna um único objeto', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, model.matchAtivoCliente(mocks_1.ID, mocks_1.ID)];
                    case 1:
                        response = _a.sent();
        ...
        it('Ao enviar codCliente e codAtivo não relacionados retorna um objeto vazio', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
