...
describe('Testa o service dos ativos', function () {
    ...
    describe('Método getById', function () {
        it('Se o ativo existe retorna status 200 e um data', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, service.getById(mocks_1.ID)];
                    case 1:
                        response = _a.sent();
                        expect(response).toHaveProperty('statusCode');
                        expect(response).toHaveProperty('data');
    ...
    describe('Método getByIdCliente', function () {
        it('Ao enviar o id de um cliente que tem ativos retorna um array', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, service.getByIdCliente(mocks_1.ID)];
                    case 1:
                        response = _a.sent();
                        expect(response).toHaveProperty('statusCode');
                        expect(response).toHaveProperty('data');
