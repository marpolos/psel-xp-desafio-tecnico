...
describe.skip('Testa o controller dos ativos', function () {
    ...
    describe('Função getById', function () {
        it('Retorna status 200 e um json quando busca um id válido', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mReq, mRes, mNext;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Função getByIdCliente', function () {
        it('Se o cliente contém ativos retorna status 200 e uma lista dos investimentos', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mReq, mRes, mNext;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
