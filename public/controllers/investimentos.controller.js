...
var venderAtivo = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.body, codAtivo = _a.codAtivo, codCliente = _a.codCliente, qtde = _a.qtde;
                return [4 /*yield*/, investimentosService
...
var comprarAtivo = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, codAtivo, codCliente, qtde, _b, statusCode, data, message;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
