...
var getById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, ativosService.getById(Number(id))];
            case 1:
                _a = _b.sent(), statusCode = _a.statusCode, data = _a.data, message = _a.message;
                if (message) {
                    return [2 /*return*/, next({
...
var getByIdCliente = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, statusCode, data, message;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, ativosService.getByIdCliente(Number(id))];
            case 1:
                _a = _b.sent(), statusCode = _a.statusCode, data = _a.data, message = _a.message;
                if (message) {
                    return [2 /*return*/, next({
...
exports.default = { getAll: getAll, getById: getById, getByIdCliente: getByIdCliente };
