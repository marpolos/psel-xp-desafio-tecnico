...
var InvestimentosService = /** @class */ (function () {
    function InvestimentosService(investimentosModel) {
        if (investimentosModel === void 0) { investimentosModel = new investimentos_model_1.default(connection_1.default); }
        this.investimentosModel = investimentosModel;
    }
    InvestimentosService.prototype.venderAtivo = function (codAtivo, codCliente, qtde) {
        return __awaiter(this, void 0, void 0, function () {
            var data, investimento;
    ...
    InvestimentosService.prototype.comprarAtivo = function (codAtivo, codCliente, qtde) {
        return __awaiter(this, void 0, void 0, function () {
            var data, investimento;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = { codAtivo: codAtivo, codCliente: codCliente, qtde: qtde };
